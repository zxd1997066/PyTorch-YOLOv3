...
function main {
    ...
    do
        ...
        #fi
        # pre run
        python detect.py --image_folder ./data/samples/ --arch YoloV3 --weights_path ${CKPT_DIR}/models/yolov3.weights --model_def ./config/yolov3.cfg \
...
function generate_core {
    ...
    do
        ...
        printf " ${OOB_EXEC_HEADER} \
            python detect.py --arch YoloV3 --image_folder ./data/samples/ \
                --weights_path ${CKPT_DIR}/models/yolov3.weights --model_def ./config/yolov3.cfg \
...
function generate_core_launcher {
    ...
    do
        ...
        printf "python -m oob-common.launch --enable_jemalloc \
            ...
            detect.py --arch YoloV3 --image_folder ./data/samples/ \
                --weights_path ${CKPT_DIR}/models/yolov3.weights --model_def ./config/yolov3.cfg \
                --num_iter ${num_iter} --num_warmup ${num_warmup} \
                --batch_size ${batch_size} \
                --precision ${precision} \
